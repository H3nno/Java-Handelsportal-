 ...
 * 
 * static int WieTief = 0; static String[][] Speichern;
 * 
 * @SuppressWarnings("deprecation") public static void Registrieren() {
 * 
 ...
 * RegistrierungsGUI.jTFNachname.getText()); writer.append(";");
 * writer.append("" +RegistrierungsGUI.jTFUsername.getText());
 * writer.append(";"); writer.append(""
 * +RegistrierungsGUI.jPFPasswort1.getText());
 * 
 ...
 * 
 * 
 * } else {RegistrierungsGUI.jStatus.setText("Passwort Fehler");} } else
 ...
 * ///////////////////////////////
 * 
 * @SuppressWarnings("deprecation") public static boolean CheckPasswords() {
 * 
 * if (!RegistrierungsGUI.jPFPasswort1.getText().equals("")) {
 * 
 * if (RegistrierungsGUI.jPFPasswort1.getText().equals(RegistrierungsGUI.
 ...
 * 
 * String Pfad = "src\\projekt\\Benutzerdaten.csv"; String line;
 * 
 * BufferedReader BR1 = null; BufferedReader BR = null;
 * 
 * try { BR1 = new BufferedReader(new FileReader(Pfad));
 * 
 * int z = 0;
 * 
 ...
 * 
 * for (int j = 0; j < 4; j++) { Speichern[z][j] = Spalten[j];
 * 
 * }
 * 
 * z++;
